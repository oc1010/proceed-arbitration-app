...
PROCEED_PROTOCOL = """The Parties and the Arbitral Tribunal shall use the secure electronic case management platform PROCEED (the “Platform”) as the primary administrative engine.
The procedural timetable maintained on the Platform’s ‘Smart Timeline’ module shall constitute the official procedural record.
